              ...
              <div key={idx} className="relative bg-gradient-to-br from-pink-100 via-white to-pink-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl overflow-hidden flex flex-col border-4 border-pink-200 dark:border-pink-700">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto flex items-center gap-2">
                    {buyUrl ? (
                      <a href={buyUrl} target="_blank" rel="noopener noreferrer" className="inline-block px-4 py-2 bg-pink-500 text-white rounded-xl font-bold shadow hover:bg-pink-600 transition flex items-center gap-2">
                        <span>Buy on Amazon</span>
                        <span className="text-lg">🔗</span>
                      </a>
                    ) : (
                      <a href={`/api/amazon?q=${encodeURIComponent(s.title || '')}`} target="_blank" rel="noopener noreferrer" className="inline-block px-4 py-2 bg-gray-700 text-white rounded-xl font-bold shadow hover:bg-gray-800 transition flex items-center gap-2">
